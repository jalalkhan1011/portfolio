<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item {{ request()->is('admin/*') ? 'active' :'' }}">
        ...
        <div id="collapseTwo"  aria-expanded="{{ request()->is('admin/*') ? 'true' :'false' }}" class="collapse {{ request()->is('admin/*') ? 'show' :'' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
