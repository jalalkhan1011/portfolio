        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="{{ !empty(Auth::user()->profile->profile_image) ? asset('uploads/profile_image/'.Auth::user()->profile->profile_image) : asset('backend/img/undraw_profile.svg')}}">
            </a>
