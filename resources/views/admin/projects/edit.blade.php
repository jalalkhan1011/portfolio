...
@section('page_title','Edit projects')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form id="project" action="{{ url('admin/projects/'.$project->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="title" value="{{ old('title',$project->title) }}" placeholder="Ex: Management software" required>
                                        @if($errors->has('title'))
                                            <span class="form-text">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <textarea  class="form-control form-control-sm" name="description"  placeholder="Write short note about project...." required rows="10">{{ $project->description }}</textarea>
